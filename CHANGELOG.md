...
- The package is now published to npm through OIDC trusted publishing instead of an access token, which also adds build provenance.
...
[0.1.1]: https://github.com/68publishers/cookie-consent/compare/v0.1.0...v0.1.1
